...
rsync -avz --delete --progress ./clusterconfig/talos-sombra.yaml "$TALOSCONFIGS_HOST:$REMOTE_CONFIG_PATH/m/94-C6-91-A2-82-AD.yaml"
rsync -avz --delete --progress ./clusterconfig/talos-lucio.yaml "$TALOSCONFIGS_HOST:$REMOTE_CONFIG_PATH/m/1C-69-7A-04-0B-76.yaml"
rsync -avz --delete --progress ./clusterconfig/talos-zarya.yaml "$TALOSCONFIGS_HOST:$REMOTE_CONFIG_PATH/m/94-C6-91-1C-FF-2E.yaml"
